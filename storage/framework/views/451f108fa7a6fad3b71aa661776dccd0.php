            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center;">
                        <form action="<?php echo e(route('books.destroy', $book->id)); ?>" method="POST" style="display:inline;" onsubmit="return confirm('Yakin hapus buku ini?')">
                            <?php echo csrf_field(); ?>
...
</html> <?php /**PATH D:\04. Kuliah\05. Semester 6\Pemrograman WEB (Lanjutan)\UAS\app-uas\resources\views/books/index.blade.php ENDPATH**/ ?>